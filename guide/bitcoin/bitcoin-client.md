...
We're talking around 785'000 blocks with a size of over 500 GB (currently), so this is not an easy task.
...
* Get the latest download links at [bitcoincore.org/en/download](https://bitcoincore.org/en/download){:target="_blank"} (x86_64), they change with each update.
...
* Still as user "bitcoin", open it with Nano and paste the configuration below.
  ...
  # dbcache = 8192
  # blocksonly = 1
  # addnode = nupedw6ky4fyg5smmfjwsi7cgyofzkuex2ajog3vesz3pyoclqfzdoid.onion:8333
  # addnode = qwzxldt5tedqtv7uf6pgwbfapnfkj3aywgm2tgwby6js724dfi3sxwyd.onion:8333
  # addnode = unsedx6ys2hb254b7yq7v7innnwtkvutjqxnnrszgghdbvvwqj7wh3qd.onion:8333
  # addnode = yweocrzyz73nj66d3sym5x4q7sepexj53vlokyo25g7k23ntg4difuid.onion:8333
  # addnode = rorqjd4wwcbckpodyi26aguu2pxmanacrw7kariobfqaflmwxps37iad.onion:8333
  # addnode = pg7fdh7fixsz6msxzmjstwpfbkg7zqyyc3weed3lr2lwnfkoidmjo7id.onion:8333
  # addnode = 2npe2p5x76dv5jz473vt2sxmuggwxu573goyct5o3i3ylk3cgwkcrfqd.onion:8333
  # addnode = w6bmcrks3qxoai54al226m3fskr233qg5ugw4hmlgkrdpykdldtfp6ad.onion:8333
  ```
...
A bigger cache speeds up the initial block download, now we want to reduce memory consumption to allow LND/CLN and Electrs/Fulcrum to run in parallel.
...
* As user "admin", comment the following lines out (add a `#` at the beginning) in the Bitcoin settings file.
  Bitcoin Core will then just use the default cache size of 300 MB instead of 8 GB.
  Save and exit.
